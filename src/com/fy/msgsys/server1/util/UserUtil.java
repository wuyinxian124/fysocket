package com.fy.msgsys.server1.util;
...
public final class UserUtil {
	 ...
	 * 一个用户对应多个连接。多个连接通过URL来标记
	 */
	private static Map<String, Map<String, Socket>> MAPUSERCONAPP;
	/**
	 * 是MAPUSERCON value
	 * <br>
	 * 格式是:<url：socket>
	...
	private UserUtil(){
		...
		MAPUSERCONAPP = new ConcurrentHashMap<String, Map<String, Socket>>();
	}
...
//			MAPUSERCON.remove(userkey);
     ...
     * @return
     */
	public synchronized  boolean verifyapp(String userkey, String verifyCode, String url,String tag, Socket connetion){
...
//			}
	...
	public List<Socket> getConnets(String userKey){
		...
		Map<String, Socket> urlConApp = MAPUSERCONAPP.get(userKey);
